...
# Bot information
SESSION = environ.get('SESSION', 'THUNDER')
API_ID = int(environ.get('API_ID', '22029006'))
API_HASH = environ.get('API_HASH', 'c203a8f1f5649378b8857a6e02f6d825')
BOT_TOKEN = environ.get('BOT_TOKEN', "7564758499:AAEVlAhnfOA42Yevrb50kHW0_CragpyO59w")
...
reqst_channel = environ.get('REQST_CHANNEL', '-1003883418032')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sohamdebnathwg:Ai8RyKuaak7awEuN@cluster0.wks1ea5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "THUNDER")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'THUNDER')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+jGdAU0mQMME0NzQ1') # Support Chat Link Without https:// or @
