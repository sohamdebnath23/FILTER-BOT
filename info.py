...
# Bot information
SESSION = environ.get('SESSION', 'ThunderNyx')
API_ID = int(environ.get('API_ID', '22029006'))
API_HASH = environ.get('API_HASH', 'c203a8f1f5649378b8857a6e02f6d825')
BOT_TOKEN = environ.get('BOT_TOKEN', "7564758499:AAFFStlWkJCgo7fEpo-bR0hv4azH5VRUjFw")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002736281938'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002734547238').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002288387344') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003883418032')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003737996570')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sohamdebnathwg:Ai8RyKuaak7awEuN@cluster0.wks1ea5.mongodb.net/?")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "MOVIEGOLDEN")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MGFILES')
...
# Links
GRP_LNK = environ.get('GRP_LNK', '-1002463463002')
CHNL_LNK = environ.get('CHNL_LNK', '-1002220447911')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1003928198320') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ThunderNyx')
